    ...
    public class Get_Data
    {
        ...
        public List<string> get_data()
        {
            ...
            if (postRequest != null)
            {
                ...
                {
                    Thread.Sleep(100); // чтоб сильно не нагружать сервак источника данных при активном парсинге (не смотря на то что я парсю всего одну группу)
                                        // вдруг решу парсить сразу всю их БД
